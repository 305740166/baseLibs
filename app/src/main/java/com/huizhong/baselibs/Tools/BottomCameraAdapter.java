 ...
 */
public class BottomCameraAdapter extends BaseAdapter {

    private List<Map<String, Object>> mData;
    private LayoutInflater mInflater;

    public BottomCameraAdapter(Context context, List<Map<String, Object>> menuData) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = mInflater.inflate(R.layout.camera_menu_item, null);
