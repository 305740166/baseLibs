 ...
 */
public class DialogSubmitCancel extends Dialog {
    //定义回调事件
    ...
    public DialogSubmitCancel(Context context, boolean isTouchOutside, String title, String txtInfo, OnCustomDialogListener customDialogListener) {
    ...
    private View.OnClickListener clickListenerHander = new View.OnClickListener() {
        ...
        public void onClick(View view) {
            ...
            DialogSubmitCancel.this.dismiss();
        }
    };
    ...
    private View.OnClickListener clickListenerHander2 = new View.OnClickListener() {
        @Override
        public void onClick(View view) {
            customDialogListener.back("dismiss");
            dismiss();
        }
    };
